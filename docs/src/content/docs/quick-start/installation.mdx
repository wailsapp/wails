   ...
   <Tabs syncKey="os">
     ...
     <TabItem label="Linux" icon="linux">
       **Build tools and WebKit**
       ...
       Applications playing audio or video also need the GStreamer codecs for
       their chosen formats. See [Play Local Audio and Video](/guides/linux-media/)
       for local media setup and playback troubleshooting.
