...
Wailsは、OSに組み込まれたWebレンダリングエンジンを使用します。
...
6. **JavaScriptでPromiseが解決され、結果が返される**
...
- **自動検出**: メソッドの手動登録不要
- **整理された**: 関連する機能をグループ化
- **テスト可能**: サービスは単なるGoの構造体

[サービスについてさらに学ぶ →](/ja/features/bindings/services)
...
[イベントについてさらに学ぶ →](/ja/features/events/system)
...
**アーキテクチャについて質問がありますか？** [Discord](https://discord.gg/JDdSxwjhGf) で質問するか、[API リファレンス](/ja/reference/overview) を確認してください。