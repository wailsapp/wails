...
次: [完全なアプリケーションを構築する](/tutorials/03-notes-vanilla)、[例](https://github.com/wailsapp/wails/tree/master/v3/examples)を閲覧、または[APIリファレンス](/reference/application)を確認してください。v2からの移行をお考えですか？[アップグレードガイド](/migration/v2-to-v3)をご覧ください。
