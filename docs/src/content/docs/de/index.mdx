...
banner:
    content: |
        Wails v3 Beta ist verfügbar. <a href="https://wails.io">Dokumentation für v2</a>
template: splash
hero:
...
Wails v3 Beta ist verfügbar. Die API ist stabil, und Anwendungen laufen bereits in der Produktion. Wir verfeinern die Dokumentation und die Tools vor dem finalen Release.
:::
