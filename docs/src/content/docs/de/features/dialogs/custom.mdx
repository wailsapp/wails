...
Erstellen Sie **benutzerdefinierte Dialogfenster** mit regulären Wails-Fenstern und dialogähnlichem Verhalten. Bauen Sie benutzerdefinierte Formulare, komplexe Eingabevalidierung, ein markenspezifisches Erscheinungsbild und reichhaltige Inhalte (Bilder, Videos), während Sie vertraute Dialogmuster beibehalten.
...
**Das war's!** Benutzerdefinierte Benutzeroberfläche mit Dialogverhalten.

## Erstellen benutzerdefinierter Dialoge

### Basis-Benutzerdefinierter Dialog
...
**Fragen?** Stellen Sie diese in [Discord](https://discord.gg/JDdSxwjhGf) oder sehen Sie sich die [Beispiele für benutzerdefinierte Dialoge](https://github.com/wailsapp/wails/tree/master/v3/examples/dialogs) an.