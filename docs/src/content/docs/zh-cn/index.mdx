...
下一步：[构建完整应用](/tutorials/03-notes-vanilla)，浏览[示例](https://github.com/wailsapp/wails/tree/master/v3/examples)，或查阅 [API 参考](/reference/application)。从 v2 迁移？请参阅[升级指南](/migration/v2-to-v3)。
