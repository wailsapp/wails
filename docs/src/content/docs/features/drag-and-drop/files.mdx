...
If your app uses both file drop and [HTML drag-and-drop](./html), see the HTML Drag & Drop guide for how to filter events so your internal drop zones don't react to external file drags.
