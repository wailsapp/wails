...
import fileDropMacOS from "../../../../assets/screenshots/file-drop-macos.png";
...
<Image src={fileDropMacOS} alt="A Wails drag-and-drop example with an external file-drop zone on macOS" style="max-width: 900px; margin: 1.5rem auto; display: block; border-radius: 10px; box-shadow: 0 8px 24px rgba(0,0,0,0.2);" />
