...
<Aside type="caution">
On macOS, transparent web content uses private WebKit APIs in the default build.
With [`noprivateapis`](/guides/build/macos#private-macos-apis), the window remains
frameless but the webview is opaque.
</Aside>
