...
import framelessV3NativeCornersMacOS from "../../../../assets/screenshots/frameless-v3-native-corners-macos.png";
...
<Image src={framelessV3NativeCornersMacOS} alt="The default Wails v3 TypeScript starter app running as a frameless window with native macOS corners" style="max-width: 768px; width: 100%; margin: 1.5rem auto; display: block; border-radius: 10px; box-shadow: 0 8px 24px rgba(0,0,0,0.2);" />
