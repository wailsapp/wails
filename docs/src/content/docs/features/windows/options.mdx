...
Controls how the window behaves across macOS Spaces and fullscreen.
**Multiple behaviors can be combined using bitwise OR (`|`).**
...
```go
// Window that appears on all Spaces (useful for launcher/spotlight-style apps)
Mac: application.MacWindow{
...
**Example - Overlay on fullscreen apps:**
