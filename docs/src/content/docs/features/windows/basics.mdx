...
<Tabs syncKey="platform">
  ...
  <TabItem label="macOS" icon="apple">
    ...
    **Backdrop types:**
    ...
    <Aside type="caution">
    Transparent web content uses private WebKit APIs in default macOS builds.
    The [`noprivateapis` build variant](/guides/build/macos#private-macos-apis)
    keeps the API unchanged but leaves the webview opaque.
    </Aside>
