...
<Tabs syncKey="platform">
   <TabItem label="Windows" icon="seti:windows">
     ...
     **Taskbar flashing:**
     ...
     Wails v3 on Windows requires the **Microsoft WebView2 Runtime** to be installed.

     **Minimum version:** 1.0.1418.22 (or later)
     ...
     **Check installed version:**
     ...
     version := runtime.GetWebView2Version()
     if version == "" {
         // WebView2 not installed
     } else if version < "1.0.1418.22" {
         // Version too old
     }
     ```
     ...
     **Installation:**
     ...
     - **Microsoft Edge (Stable):** Includes WebView2 automatically
     - **Windows 10+ (Build 19041):** May have pre-installed version

     **Troubleshooting:**

     If you see "unsupported capability" errors:

     1. Install the latest WebView2 Runtime
     2. Restart your application
     3. Check installed version with `runtime.GetWebView2Version()`

     See the [webview2 package documentation](https://github.com/wailsapp/wails/tree/master/webview2) for detailed information about the generator and version compatibility.
   </TabItem>
