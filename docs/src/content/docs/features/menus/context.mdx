...
import contextMenuMacOS from "../../../../assets/screenshots/context-menu-macos.png";
...
<Image src={contextMenuMacOS} alt="A Wails custom context menu displayed over a webview on macOS" style="max-width: 900px; margin: 1.5rem auto; display: block; border-radius: 10px; box-shadow: 0 8px 24px rgba(0,0,0,0.2);" />
