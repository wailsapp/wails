...
import applicationMenuMacOS from "../../../../assets/screenshots/application-menu-macos.png";
...
<Image src={applicationMenuMacOS} alt="A Wails application menu on macOS with standard, checkbox, radio, and submenu items" style="max-width: 280px; margin: 1.5rem auto; display: block; border-radius: 10px; box-shadow: 0 8px 24px rgba(0,0,0,0.2);" />
