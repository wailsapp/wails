...
import fileDialogMacOS from "../../../../assets/screenshots/file-dialog-macos.png";
...
<Image src={fileDialogMacOS} alt="A native macOS file picker opened by a Wails application" style="max-width: 900px; margin: 1.5rem auto; display: block; border-radius: 10px; box-shadow: 0 8px 24px rgba(0,0,0,0.2);" />
