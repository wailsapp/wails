...
func saveDocument(app *application.App, content string) {
    ...
    if ext != ".txt" && ext != ".md" {
        ...
        dialog.Buttons(
			application.Button{Label: "Save"},
			application.Button{Label: "Cancel", IsDefault: true, IsCancel: true},
		)

		result, err := dialog.Result()
		if err != nil || result != "Save" {
			return
		}
    }
...
func processMultipleFiles(app *application.App) {
    ...
    dialog.Buttons(
		application.Button{Label: "Process"},
		application.Button{Label: "Cancel", IsDefault: true, IsCancel: true},
	)

    result, err := dialog.Result()
    if err != nil || result != "Process" {
        return
    }
...
func exportData(app *application.App, data []byte) {
    ...
    dialog.Buttons(
		application.Button{Label: "Open Folder"},
...
func importConfiguration(app *application.App) {
    ...
    dialog.Buttons(
		application.Button{Label: "Import"},
		application.Button{Label: "Cancel", IsDefault: true, IsCancel: true},
	)

    result, err := dialog.Result()
    if err != nil || result != "Import" {
        return
    }
