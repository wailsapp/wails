...
import dialogQuestionMacOS from "../../../../assets/screenshots/dialog-question-macos.png";
...
<Image src={dialogQuestionMacOS} alt="A Wails question dialog on macOS with Cancel and Discard buttons" style="max-width: 800px; margin: 1.5rem auto; display: block; border-radius: 10px; box-shadow: 0 8px 24px rgba(0,0,0,0.2);" />
