...
7. ## Run the app and verify the update
   ...
   Click **App → Check for Updates…**. This time you should see:
...
10. ## Customise the window
    ...
    <Tabs>
        ...
        <TabItem label="Bring your own window">
            ...
            Useful when you already have your own window infrastructure and want the updater to drive it instead of opening another window.
        </TabItem>
    </Tabs>
