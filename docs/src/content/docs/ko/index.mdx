...
다음: [완전한 애플리케이션 빌드하기](/tutorials/03-notes-vanilla), [예제 보기](https://github.com/wailsapp/wails/tree/master/v3/examples), 또는 [API 레퍼런스](/reference/application) 확인하기. v2에서 마이그레이션 중이신가요? [업그레이드 가이드](/migration/v2-to-v3)를 참고하세요.
