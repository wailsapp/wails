---
title: Manager API
description: 具有專注管理器介面的組織化 API 結構
sidebar:
  order: 2
---
...
Wails v3 Manager API 提供了一種組織化且易於發現的方式，透過專注的管理器結構體來存取應用程式功能。這種新的 API 結構將相關方法分組，同時保持與傳統 App API 的完全向後相容性。

## 概述

Manager API 將應用程式功能組織成十一個專注領域：
...
- **更好的可發現性** - IDE 自動完成功能顯示組織化的 API 介面
- **改善的程式碼組織** - 相關方法分組在一起
- **增強的可維護性** - 各管理器之間的關注點分離
- **未來的可擴展性** - 更容易向特定領域新增新功能

## 使用方式

Manager API 提供對所有應用程式功能的組織化存取：
