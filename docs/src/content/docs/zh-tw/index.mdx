...
下一步：[建構完整的應用程式](/tutorials/03-notes-vanilla)，瀏覽[範例](https://github.com/wailsapp/wails/tree/master/v3/examples)，或查看 [API 參考](/reference/application)。從 v2 遷移？請參閱[升級指南](/migration/v2-to-v3)。
