...
此頁面列出了由社群支援的範本。若要建立您自己的
範本，請參閱 [範本](https://wails.io/docs/guides/templates)
指南。
...
- [wails-svelte-tailwind-vite-template](https://github.com/PylotLight/wails-vite-svelte-tailwind-template/tree/master) -
  使用 Svelte v4.2.0 和 Vite 並搭配 TailwindCSS v3.3.3 的更新版
  範本
...
- [wails-template-shadcn-svelte](https://github.com/xijaja/wails-template-shadcn-svelte) -
  使用 Sveltekit 和 Shadcn-Svelte 的
  範本
...
- [wails-pure-js-template](https://github.com/KiddoV/wails-pure-js-template) - 一個僅包含基本 JavaScript、HTML 和 CSS 的
  範本
