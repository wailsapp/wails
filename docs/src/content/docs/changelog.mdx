...
- Add badging support for macOS and Windows by [@popaprozac](https://github.com/popaprozac) in [#4234](https://github.com/wailsapp/wails/pull/4234)
- Add Content Protection on Windows/Mac by [@leaanthony](https://github.com/leaanthony) based on the original work of [@Taiterbase](https://github.com/Taiterbase) in [#4241](https://github.com/wailsapp/wails/pull/4241)
