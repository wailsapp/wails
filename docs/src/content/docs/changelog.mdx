...
- Add systray hide/show on Windows by [@leaanthony](https://github.com/leaanthony)
...
- Fixed cancel in File dialogs on Windows by [@leaanthony](https://github.com/leaanthony)
