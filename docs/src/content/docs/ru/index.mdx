...
Далее: [Создайте полноценное приложение](/tutorials/03-notes-vanilla), просмотрите [примеры](https://github.com/wailsapp/wails/tree/master/v3/examples) или ознакомьтесь со [справочником API](/reference/application). Переходите с v2? См. [руководство по обновлению](/migration/v2-to-v3).
