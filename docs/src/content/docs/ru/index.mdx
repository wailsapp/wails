...
banner:
    content: |
        Wails v3 доступен. <a href="https://wails.io">Документация v2</a>
template: splash
hero:
...
Wails v3 доступен. API стабилен, и приложения уже работают в продакшене. Мы дорабатываем документацию и инструменты перед финальным релизом.
:::
