---
title: Пользовательские диалоги
description: Создавайте пользовательские диалоги в ваших приложениях Wails
sidebar:
  order: 4
---
...
Создавайте **пользовательские диалоговые окна** с помощью обычных окон Wails, обладающих поведением, характерным для диалогов. Разрабатывайте пользовательские формы, сложную проверку ввода, фирменный внешний вид и богатый контент (изображения, видео), сохраняя при этом привычные паттерны взаимодействия с диалогами.
...
**Вот и всё!** Пользовательский интерфейс с поведением диалога.

## Создание пользовательских диалогов

### Базовый пользовательский диалог
...
**Вопросы?** Задавайте их в [Discord](https://discord.gg/JDdSxwjhGf) или смотрите [примеры пользовательских диалогов](https://github.com/wailsapp/wails/tree/master/v3/examples/dialogs).