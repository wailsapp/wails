...
Tags are forwarded as `EXTRA_TAGS` to the underlying Taskfile. See [Server Build](/guides/server-build) and [Linux Packaging - Legacy GTK3 Support](/guides/build/linux#legacy-gtk3-support) for details.
