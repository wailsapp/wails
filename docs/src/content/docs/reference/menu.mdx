...
Context menus are right-click menus associated with HTML elements via the `data-wails-context-menu` attribute.

### Creating Context Menus

Use `NewContextMenu()` to create and auto-register a context menu:
