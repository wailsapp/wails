...
**Linux:**
- `gcc`, `pkg-config`, `libgtk-3-dev`, `libwebkit2gtk-4.1-dev` (GTK4 build also supported via `libwebkitgtk-6.0-dev`)
- Install via: `sudo apt install build-essential pkg-config libgtk-3-dev libwebkit2gtk-4.1-dev` (Debian/Ubuntu)
