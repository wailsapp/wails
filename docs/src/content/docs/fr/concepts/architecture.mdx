...
[En savoir plus sur les services →](/fr/features/bindings/services)
...
[En savoir plus sur les événements →](/fr/features/events/system)
...
**Des questions sur l'architecture ?** Posez-les sur [Discord](https://discord.gg/JDdSxwjhGf) ou consultez la [référence de l'API](/fr/reference/overview).