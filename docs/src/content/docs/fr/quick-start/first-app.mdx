...
- Liaisons typées (type-safe bindings)
...
3. **Lancer l'application**
   ...
   L'application s'ouvre en affichant une interface de salutation. Entrez votre nom et cliquez sur "Greet" (Saluer) - le backend Go traite votre saisie et renvoie une salutation.

</Steps>

## Comment cela fonctionne

Comprendons le code qui rend cela possible.
...
3. **Logique simple** - Prend un nom et renvoie une salutation
...
<Tabs syncKey="os">
  ...
  <TabItem label="macOS" icon="apple">
    **Sortie :** `build/bin/myapp.app`
    ...
    Glissez-déposez dans le dossier Applications ou double-cliquez pour exécuter.
  </TabItem>
...
Vous voulez compiler pour d'autres plateformes ? Consultez [Compilations multi-plateformes →](/fr/guides/build/cross-platform)
:::
...
**Services**
- Créez des structs Go avec des méthodes exportées
