...
banner:
    content: |
        Wails v3 est disponible. <a href="https://wails.io">Documentation v2</a>
template: splash
hero:
...
Wails v3 est disponible. L'API est stable et des applications fonctionnent déjà en production. Nous affinons la documentation et les outils avant la version finale.
:::
