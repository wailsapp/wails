...
{/* TODO: use the cards below for some of the content */}
...
2. [Create Your First Application](./getting-started/your-first-app.md): Learn
   how to create your first Wails application with our step-by-step tutorial.
3. [Explore the API Reference](./api/application.mdx): Dive deeper into the API
   documentation.
