...
<p style="font-size: 0.875rem; color: var(--sl-color-gray-3); margin-top: 0.5rem;">Having issues with <code>wails3 setup</code>? See the <a href="/getting-started/setup">manual setup guide</a>.</p>
