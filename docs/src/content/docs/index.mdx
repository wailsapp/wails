...
banner:
    content: |
        Wails v3 is currently in beta. <a href="https://v2.wails.io">Looking for v2 docs?</a>
template: splash
hero:
...
<CardGrid>
  ...
  <Card title="Desktop-ready" icon="approve-check">
