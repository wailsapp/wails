...
<style>{`
  ...
  body::after {
    ...
    background: 
      ...
      url('/showcase-images/wombat.webp') 350px center / auto 80% no-repeat,
      url('/showcase-images/riftshare-main.webp') 700px center / auto 80% no-repeat,
      url('/showcase-images/optimus.webp') 1050px center / auto 80% no-repeat,
      url('/showcase-images/portfall.webp') 1400px center / auto 80% no-repeat,
      url('/showcase-images/resizem.webp') 1750px center / auto 80% no-repeat,
      url('/showcase-images/wally.webp') 2100px center / auto 80% no-repeat,
      url('/showcase-images/october.webp') 2450px center / auto 80% no-repeat,
      url('/showcase-images/tiny-rdm1.webp') 2800px center / auto 80% no-repeat,
      url('/showcase-images/wombat.webp') 3150px center / auto 80% no-repeat,
      url('/showcase-images/riftshare-main.webp') 3500px center / auto 80% no-repeat,
  ...
  html::after {
    ...
    background:
      ...
      url('/showcase-images/october.webp') 1050px center / auto 80% no-repeat,
      url('/showcase-images/tiny-rdm1.webp') 1400px center / auto 80% no-repeat,
      url('/showcase-images/wombat.webp') 1750px center / auto 80% no-repeat,
      url('/showcase-images/riftshare-main.webp') 2100px center / auto 80% no-repeat,
      url('/showcase-images/optimus.webp') 2450px center / auto 80% no-repeat,
      url('/showcase-images/portfall.webp') 2800px center / auto 80% no-repeat,
      url('/showcase-images/resizem.webp') 3150px center / auto 80% no-repeat,
      url('/showcase-images/wally.webp') 3500px center / auto 80% no-repeat,
      url('/showcase-images/october.webp') 3850px center / auto 80% no-repeat;
  ...
  body::before {
    ...
    background:
      ...
      url('/showcase-images/wombat.webp') 1050px center / auto 80% no-repeat,
      url('/showcase-images/riftshare-main.webp') 1400px center / auto 80% no-repeat,
      url('/showcase-images/optimus.webp') 1750px center / auto 80% no-repeat,
      url('/showcase-images/portfall.webp') 2100px center / auto 80% no-repeat,
      url('/showcase-images/resizem.webp') 2450px center / auto 80% no-repeat,
      url('/showcase-images/wally.webp') 2800px center / auto 80% no-repeat,
      url('/showcase-images/october.webp') 3150px center / auto 80% no-repeat,
      url('/showcase-images/tiny-rdm1.webp') 3500px center / auto 80% no-repeat,
      url('/showcase-images/wombat.webp') 3850px center / auto 80% no-repeat;
...
Ready to dive deeper? [Explore the complete tutorial](/tutorials/notes-vanilla) to build a full notes application, browse [real-world examples](https://github.com/wailsapp/wails/tree/v3-alpha/v3/examples), or check out the [API reference](/reference/application-api) for advanced features. Migrating from v2? See the [upgrade guide](/migration/v2-to-v3).
