...
1. Discuss your idea on [Discord](https://discord.gg/JDdSxwjhGf) or [GitHub Discussions](https://github.com/wailsapp/wails/discussions).
...
3. Open a draft pull request titled `[WEP] <title>` containing only the proposal, and post it in the [#enhancement-proposals](https://discord.gg/TA8kbQds95) channel on Discord.
