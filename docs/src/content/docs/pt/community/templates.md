...
Se não houver um sufixo de versão, o modelo de código do branch principal é usado por padrão.
...
- [wails-template-vue](https://github.com/misitebao/wails-template-vue) - Modelo Wails
  baseado na ecossistema Vue (TypeScript integrado, tema escuro,
...
- [wails-pure-js-template](https://github.com/KiddoV/wails-pure-js-template) - Um
  modelo com apenas JavaScript básico, HTML e CSS
