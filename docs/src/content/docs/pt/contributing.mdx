...
Agradecemos suas contribuições para o Wails! Seja corrigindo bugs, adicionando recursos ou melhorando a documentação, seu auxílio é muito apreciado.
...
# Crie um branch para o recurso
git checkout -b feature/my-feature
```

### Faça Suas Alterações

1. **Escreva o código** seguindo as convenções do Go
...
// ❌ Ruim: Sem docs, sem tratamento de erros
