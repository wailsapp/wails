...
Untuk aplikasi produksi, Anda biasanya menambahkan persistensi database. Lihat panduan [Integrasi Database](/id/guides/patterns/database) untuk contoh dengan SQLite, PostgreSQL, dll.
...
- **Tambahkan persistensi:** Buat todo bertahan setelah restart aplikasi dengan [SQLite](/id/guides/patterns/database)
