...
[Dokumentasi mobile →](/guides/mobile)
...
Selanjutnya: [Bangun aplikasi lengkap](/tutorials/03-notes-vanilla), jelajahi [contoh](https://github.com/wailsapp/wails/tree/master/v3/examples), atau lihat [referensi API](/reference/application). Migrasi dari v2? Lihat [panduan upgrade](/migration/v2-to-v3).
