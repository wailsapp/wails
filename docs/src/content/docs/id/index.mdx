...
banner:
    content: |
        Wails v3 tersedia. <a href="https://wails.io">dokumentasi v2</a>
template: splash
hero:
...
:::note[Siap Produksi]
Wails v3 tersedia. API stabil, dan aplikasi sudah berjalan di produksi. Kami menyempurnakan dokumentasi dan tooling sebelum rilis final.
:::
