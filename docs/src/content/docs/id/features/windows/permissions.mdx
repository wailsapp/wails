...
<Aside type="caution" title="Tolak apa yang tidak dideklarasikan Info.plist Anda">
...
Di **macOS** ini mengizinkan keduanya di lapisan WebKit, sehingga tidak ada prompt browser yang muncul; TCC tetap menanyakan perangkatnya sendiri saat pertama kali digunakan, dan kedua kunci deskripsi penggunaan harus ada di `Info.plist`.
...
| Mikrofon | ✅ | ✅ | ✅ (macOS 12+) |
| Kamera | ✅ | ✅ | ✅ (macOS 12+) |
| Geolokasi | ❌ belum | ✅ | ❌ belum |
| Notifikasi | ❌ belum | ✅ | ❌ belum |
| Clipboard Read | ❌ belum | ✅ | ❌ belum |
