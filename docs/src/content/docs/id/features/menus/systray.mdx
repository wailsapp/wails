---
title: Menu System Tray
description: Tambahkan integrasi system tray ke aplikasi Anda
sidebar:
  order: 3
---
...
Wails menyediakan **API system tray terpadu** yang bekerja di semua platform. Buat ikon tray dengan menu, lampirkan window, dan tangani klik dengan perilaku platform native untuk aplikasi background, service, dan utilitas akses cepat.
...
After changing menu state, **call `menu.Update()`**. See [Menu Reference](/id/features/menus/reference#enabled-state).
:::
...
<CardGrid>
  ...
  <Card title="System Tray Tutorial" icon="open-book">
    ...
    [Pelajari Selengkapnya →](/id/tutorials/system-tray)
  </Card>
</CardGrid>

---

**Pertanyaan?** Tanyakan di [Discord](https://discord.gg/JDdSxwjhGf) or lihat [system tray examples](https://github.com/wailsapp/wails/tree/master/v3/examples/systray-basic).
