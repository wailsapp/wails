...
description: Referensi lengkap tipe item menu, properti, dan metode
sidebar:
  order: 4
---
...
Referensi lengkap untuk tipe item menu, properti, dan perilaku dinamis. Bangun menu profesional dan responsif dengan checkbox, radio group, separator, dan pembaruan dinamis.
...
- [Application Menus](/id/features/menus/application) - Create application menu bars
- [Context Menus](/id/features/menus/context) - Right-click context menus
- [System Tray Menus](/id/features/menus/systray) - System tray/menu bar menus
- [Menu Patterns](/id/guides/menus) - Common menu patterns and best practices

---

**Pertanyaan?** Tanyakan di [Discord](https://discord.gg/JDdSxwjhGf) or lihat [menu examples](https://github.com/wailsapp/wails/tree/master/v3/examples/menu).
