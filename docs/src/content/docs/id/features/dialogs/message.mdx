---
title: Dialog Pesan
description: Tampilkan informasi, peringatan, error, dan pertanyaan
sidebar:
  order: 2
---
...
Wails menyediakan **dialog pesan native** dengan tampilan sesuai platform: dialog info, peringatan, error, dan pertanyaan dengan judul, pesan, dan tombol yang dapat disesuaikan. API sederhana, perilaku native, accessible secara default.

## Membuat Dialog

Dialog pesan diakses melalui `app.Dialog` manager:
...
Semua metode mengembalikan `*MessageDialog` that can be configured using method chaining.
...
**Satu tombol (Info/Peringatan/Error):**
...
<CardGrid>
  ...
  <Card title="Notifications" icon="bell">
    ...
    [Pelajari Selengkapnya →](/id/features/notifications/overview)
  </Card>
