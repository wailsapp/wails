...
1. **Generate proyek**
   ...
   [bawa framework frontend Anda sendiri](/guides/dev/frontend-frameworks).
   :::
...
Ingin build untuk platform lain? Lihat [Build Cross-Platform →](/guides/build/cross-platform)
:::
