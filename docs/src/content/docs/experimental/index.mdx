...
actually happened. Tell us on GitHub Discussions:

<CardGrid>
  <LinkCard
    title="GitHub Discussions"
    description="Tell us how an experiment worked out, what broke, or what's missing — and mention which experiment."
...
<Aside type="note">
As more experiments land, each gets its own page in this section.
</Aside>
