...
Записи журнала изменений v3 создаются автоматически при слиянии вашего PR. Чтобы задать формулировку, добавьте свою запись в `v3/UNRELEASED_CHANGELOG.md`: автоматизация использует её вместо сгенерированной.
