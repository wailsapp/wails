...
### macOS: нативное оформление окна

Помимо кнопок строки заголовка, окна macOS могут содержать нативную панель инструментов `NSToolbar`, боковую панель со списком источников, список содержимого, инспектор свойств, полосы дополнительных элементов строки заголовка и вкладки окон — всё это создаётся из Go. Полное описание API приведено в руководстве [Нативное оформление окна macOS](/guides/macos-native-chrome/).
