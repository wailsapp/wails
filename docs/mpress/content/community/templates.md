...
This page serves as a list for community supported templates. To build your own template, please see the [Templates](https://wails.io/docs/guides/templates) guide.

@note{type="tip" title="How to Submit a Template"}
