---
title: "Clip"
description: "A simple, cross-platform RSS reader — for macOS / Windows, built for fast browsing and distraction-free reading."
slug: "community/showcase/clip"
sourcePath: "community/showcase/clip.md"
---

![Clip screenshot](/assets/showcase-images/clip.png)

- **Three-column layout**: source/folder tree · article list · reading view
- **Subscription management**: add feeds, organise into folders, OPML import/export
