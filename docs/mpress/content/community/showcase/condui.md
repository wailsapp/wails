...
Condui is an SSH connection manager with end-to-end encrypted, multi-device sync. It keeps your connections, SSH tunnels and vault-protected credentials in sync across every device you use, without the sync server ever seeing your plaintext credentials.
