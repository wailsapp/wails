...
@steps
### Write a WEP
- Read the [WEP (Wails Enhancement Proposal) process](https://github.com/wailsapp/wails/blob/master/v3/wep/README.md)
- Copy the WEP template into `v3/wep/proposals/<name>/proposal.md`
- Open a draft PR titled `[WEP] <title>` containing the WEP only
- Wait for a maintainer decision before implementing
...
- Update relevant documentation in `/docs/mpress/content/`
...
[Documentation]
Correction PRs are welcome without opening an issue first. Documentation-only  
corrections do not need a failing code test. Follow  
[Correct the documentation](/contributing/documentation/) for the M-Press  
installation, source paths, preview, validation and PR steps.
...
- Explore the [Technical Documentation](/contributing/overview/)
