...
@note{type="info"}
Prerequisites: You should be comfortable with **Go 1.25+**, basic TypeScript, and modern frontend build tools. If you are new to Go, consider skimming the official tour first.
