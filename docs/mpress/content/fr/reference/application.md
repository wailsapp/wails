...
L’application fournit un assainisseur pour masquer les données sensibles. Les journaux IPC sont automatiquement assainis par défaut.

### Sanitizer()

Renvoie l’instance de l’assainisseur de l’application.
...
Configurez l’assainissement avec `SanitizeOptions` dans les options de l’application :
...
Consultez le [guide de sécurité](/guides/security/) pour la documentation complète.
