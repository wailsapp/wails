...
Our goal is to reach a stable v3.0 release. This roadmap outlines the key features and improvements we need to implement before the final release. Please note that this is a living document and may be updated as priorities shift or new insights emerge.
...
This roadmap is subject to change based on community feedback and project priorities. We'll update it regularly to reflect progress and changes in direction. Report reproducible problems as issues; propose new functionality through a [WEP (Wails Enhancement Proposal)](https://github.com/wailsapp/wails/blob/master/v3/wep/README.md) PR.
