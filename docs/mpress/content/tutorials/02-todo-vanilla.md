...
For production apps, add persistence using the storage solution that best fits your application, such as SQLite, PostgreSQL, or a hosted service.
...
This creates an optimized native executable in `bin/`:
...
- **Add persistence:** Make todos survive app restarts with SQLite or another storage solution
