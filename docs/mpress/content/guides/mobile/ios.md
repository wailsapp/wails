...
@note{type="tip"}
For automatically managed signing, provisioning and App Store archives, open the generated Xcode project with `wails3 task ios:xcode` and build from Xcode instead.
