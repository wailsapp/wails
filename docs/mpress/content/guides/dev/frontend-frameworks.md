...
@note{type="tip" title="Generate a plain JavaScript project"}
...
@note{type="info"}
If you build a polished setup for a framework, consider publishing it as a [custom template](/guides/advanced/custom-templates/) so others can `wails3 init -t` it directly.
