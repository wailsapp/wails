...
<span class="browser-footnote" data-browser-footnote>* unless you really want to</span>
<script>
(() => {
...
Having issues with `wails3 setup`? See the [manual installation guide](/quick-start/installation/).
...
Wails v3 is beta software with a stable desktop API. Teams are already using it in production, but should test thoroughly before deployment while we complete the final polish for 3.0.
