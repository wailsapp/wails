...
| `signatureAlgo` / `signature` | string / base64 | no | `ed25519`, `ed25519ph`, or `ecdsa-p256`. `signatureAlgo` is required whenever `signature` is present. See the [updater guide](/guides/updater/#cryptographic-verification) for what each algorithm signs. |
