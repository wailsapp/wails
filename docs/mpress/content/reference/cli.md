...
| `wails3 mcp` | Start the project MCP server. Automatically uses stdio for agent-launched processes or loopback Streamable HTTP for interactive terminal use. |
