...
Aplikasi menyediakan sanitizer untuk menyamarkan data sensitif. Log IPC disanitasi secara otomatis secara default.

### Sanitizer()

Mengembalikan instans sanitizer aplikasi.
...
Konfigurasikan sanitasi melalui `SanitizeOptions` pada opsi aplikasi:
...
Lihat [panduan keamanan](/guides/security/) untuk dokumentasi lengkap.
