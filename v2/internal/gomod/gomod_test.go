...
require github.com/wailsapp/wails/v2 v2.0.0-beta.18
...
require (
	github.com/wailsapp/wails/v2 v2.0.0-beta.18
)
...
func TestUpdateGoModVersion(t *testing.T) {
	...
	tests := []struct {
		...
		{"basic", args{[]byte(basic), "v2.0.0-beta.18"}, []byte(basicUpdated), false},
		{"basicmultiline", args{[]byte(multilineRequire), "v2.0.0-beta.18"}, []byte(multilineRequireUpdated), false},
		{"basicmultilinereplace", args{[]byte(multilineReplace), "v2.0.0-beta.18"}, []byte(multilineReplaceUpdated), false},
		{"basicmultilinereplaceblock", args{[]byte(multilineReplaceBlock), "v2.0.0-beta.18"}, []byte(multilineReplaceBlockUpdated), false},
		{"basicmultilinereplacenoversion", args{[]byte(multilineReplaceNoVersion), "v2.0.0-beta.18"}, []byte(multilineReplaceNoVersionUpdated), false},
		{"basicmultilinereplacenoversionblock", args{[]byte(multilineReplaceNoVersionBlock), "v2.0.0-beta.18"}, []byte(multilineReplaceNoVersionBlockUpdated), false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestGoModOutOfSync(t *testing.T) {
	...
	tests := []struct {
		...
		{"basic", args{[]byte(basic), "v2.0.0-beta.18"}, true, false},
		{"basicmultiline", args{[]byte(multilineRequire), "v2.0.0-beta.18"}, true, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
replace github.com/wailsapp/wails/v2 v2.0.0-beta.18 => C:\Users\leaan\Documents\wails-v2-beta\wails\v2
`
...
replace (
	github.com/wailsapp/wails/v2 v2.0.0-beta.18 => C:\Users\leaan\Documents\wails-v2-beta\wails\v2
)
`
