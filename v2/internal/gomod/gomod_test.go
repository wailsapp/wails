...
func TestUpdateGoModVersion(t *testing.T) {
	...
	tests := []struct {
		...
		{"basicmultilinereplace", args{[]byte(multilineReplace), "v2.0.0-beta.11"}, []byte(multilineReplaceUpdated), false},
		{"basicmultilinereplaceblock", args{[]byte(multilineReplaceBlock), "v2.0.0-beta.11"}, []byte(multilineReplaceBlockUpdated), false},
		{"basicmultilinereplacenoversion", args{[]byte(multilineReplaceNoVersion), "v2.0.0-beta.11"}, []byte(multilineReplaceNoVersionUpdated), false},
		{"basicmultilinereplacenoversionblock", args{[]byte(multilineReplaceNoVersionBlock), "v2.0.0-beta.11"}, []byte(multilineReplaceNoVersionBlockUpdated), false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
replace github.com/wailsapp/wails/v2 v2.0.0-beta.11 => C:\Users\leaan\Documents\wails-v2-beta\wails\v2
`
...
replace (
	github.com/wailsapp/wails/v2 v2.0.0-beta.11 => C:\Users\leaan\Documents\wails-v2-beta\wails\v2
)
`
