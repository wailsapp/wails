...
const (
	...
	DLLSearchDontResolveDllReferences uint32 = 0x1
	DLLSearchAsDataFile               uint32 = 0x2
	DLLSearchWithAlteredPath          uint32 = 0x8
	DLLSearchIgnoreCodeAuthzLevel     uint32 = 0x10
	DLLSearchAsImageResource          uint32 = 0x20
	DLLSearchAsDataFileExclusive      uint32 = 0x40
	DLLSearchRequireSignedTarget      uint32 = 0x80
	DLLSearchDllLoadDir               uint32 = 0x100
	DLLSearchApplicationDir           uint32 = 0x200
	DLLSearchUserDirs                 uint32 = 0x400
	DLLSearchSystem32                 uint32 = 0x800
	DLLSearchDefaultDirs              uint32 = 0x1000
	DLLSearchSafeCurrentDirs          uint32 = 0x2000
	DLLSearchSystem32NoForwarder      uint32 = 0x4000
	DLLSearchOsIntegrityContinuity    uint32 = 0x8000
)
