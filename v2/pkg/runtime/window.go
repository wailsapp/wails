...
// WindowGetDimensions returns the height and width of the current screen
func WindowGetDimensions(ctx context.Context) (int, int) {
	appFrontend := getFrontend(ctx)
	return appFrontend.WindowGetDimensions()
}
