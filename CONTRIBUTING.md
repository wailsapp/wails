...
- **Enhancements require prior discussion** on [Discord](https://discord.gg/JDdSxwjhGf) (see the [feedback guide](https://v3.wails.io/feedback/)). Substantial new functionality goes through the [Wails Enhancement Proposal (WEP) process](v3/wep/README.md).
