...
// GetICoreWebView2Profile8 queries the object for its ICoreWebView2Profile8 interface. The receiver
// is the root of ICoreWebView2Profile8's inheritance chain — the object that actually
// implements it.
