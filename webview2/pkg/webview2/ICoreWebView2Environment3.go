...
// GetICoreWebView2Environment3 queries the object for its ICoreWebView2Environment3 interface. The receiver
// is the root of ICoreWebView2Environment3's inheritance chain — the object that actually
// implements it.
