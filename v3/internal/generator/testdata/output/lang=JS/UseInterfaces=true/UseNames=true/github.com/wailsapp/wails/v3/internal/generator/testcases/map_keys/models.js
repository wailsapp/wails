 ...
 * @property {{ [_ in string]?: number } | null} GACi - Accept
 * @property {{ [_ in string]?: number } | null} GACV - Accept
 ...
 * @property {{ [_ in string]?: number } | null} GABi - Accept
 * @property {{ [_ in string]?: number } | null} GABs - Accept
 ...
 * @property {{ [_ in string]?: number } | null} GAGT - Accept
 * @property {{ [_ in string]?: number } | null} GAGTPtr - Accept, hide
 * @property {{ [_ in string]?: number } | null} GANBV - Accept
 ...
 * @property {{ [_ in string]?: number } | null} GAPlV1 - Accept
 * @property {{ [_ in string]?: number } | null} GAPlV2 - Accept
 * @property {{ [_ in string]?: number } | null} GAPlP1 - Reject
 * @property {{ [_ in string]?: number } | null} GAPlP2 - Accept
 * @property {{ [_ in string]?: number } | null} GAPlVPtr - Accept, hide
 * @property {{ [_ in string]?: number } | null} GAPlPPtr - Accept, hide
 * @property {{ [_ in string]?: number } | null} GAMi - Accept
 * @property {{ [_ in string]?: number } | null} GAMS - Accept
 * @property {{ [_ in string]?: number } | null} GAMV - Accept
 ...
 * @property {{ [_ in string]?: number } | null} GAIV - Accept
