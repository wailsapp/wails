...
export interface Maps<R, S, T, U, V, W, X, Y, Z> {
     ...
     * Accept
     */
    "GACi": { [_ in string]?: number } | null;

    /**
     * Accept
     */
    "GACV": { [_ in string]?: number } | null;
     ...
     * Accept
     */
    "GABi": { [_ in string]?: number } | null;

    /**
     * Accept
     */
    "GABs": { [_ in string]?: number } | null;
     ...
     * Accept
     */
    "GAPlV1": { [_ in string]?: number } | null;

    /**
     * Accept
     */
    "GAPlV2": { [_ in string]?: number } | null;
     ...
     * Accept
     */
    "GAPlP2": { [_ in string]?: number } | null;
     ...
     * Accept
     */
    "GAMi": { [_ in string]?: number } | null;

    /**
     * Accept
     */
    "GAMS": { [_ in string]?: number } | null;

    /**
     * Accept
     */
    "GAMV": { [_ in string]?: number } | null;
