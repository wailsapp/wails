...
type GenerateBindingsOptions struct {
	...
	TimeType          string `name:"time-type" description:"How time.Time values are rendered: 'string' (default, RFC3339 string) or 'Date' (JavaScript Date object)" default:"string"`
