...
// Execute runs the internal Taskfile executor explicitly. CLI Taskfile commands
// use the embedded Task runtime; this entry point does not select CLI behavior.
