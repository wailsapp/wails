(() => {
  ...
  var call6 = newRuntimeCaller("contextmenu");
  function openContextMenu(id, x, y, data) {
    return call6("OpenContextMenu", { id, x, y, data });
  }
