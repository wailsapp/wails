...
// GetICoreWebView2_7 queries the object for its ICoreWebView2_7 interface. The receiver
// is the root of ICoreWebView2_7's inheritance chain — the object that actually
// implements it.
