...
// GetICoreWebView2Frame7 queries the object for its ICoreWebView2Frame7 interface. The receiver
// is the root of ICoreWebView2Frame7's inheritance chain — the object that actually
// implements it.
