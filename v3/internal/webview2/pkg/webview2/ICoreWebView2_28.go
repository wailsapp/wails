...
// GetICoreWebView2_28 queries the object for its ICoreWebView2_28 interface. The receiver
// is the root of ICoreWebView2_28's inheritance chain — the object that actually
// implements it.
