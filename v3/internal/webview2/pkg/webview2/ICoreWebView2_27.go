...
// GetICoreWebView2_27 queries the object for its ICoreWebView2_27 interface. The receiver
// is the root of ICoreWebView2_27's inheritance chain — the object that actually
// implements it.
