...
// GetICoreWebView2_19 queries the object for its ICoreWebView2_19 interface. The receiver
// is the root of ICoreWebView2_19's inheritance chain — the object that actually
// implements it.
