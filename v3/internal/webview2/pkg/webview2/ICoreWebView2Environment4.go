...
// GetICoreWebView2Environment4 queries the object for its ICoreWebView2Environment4 interface. The receiver
// is the root of ICoreWebView2Environment4's inheritance chain — the object that actually
// implements it.
