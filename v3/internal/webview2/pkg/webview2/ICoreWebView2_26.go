...
// GetICoreWebView2_26 queries the object for its ICoreWebView2_26 interface. The receiver
// is the root of ICoreWebView2_26's inheritance chain — the object that actually
// implements it.
