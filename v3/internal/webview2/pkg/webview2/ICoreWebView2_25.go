...
// GetICoreWebView2_25 queries the object for its ICoreWebView2_25 interface. The receiver
// is the root of ICoreWebView2_25's inheritance chain — the object that actually
// implements it.
