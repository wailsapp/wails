...
// GetICoreWebView2_24 queries the object for its ICoreWebView2_24 interface. The receiver
// is the root of ICoreWebView2_24's inheritance chain — the object that actually
// implements it.
