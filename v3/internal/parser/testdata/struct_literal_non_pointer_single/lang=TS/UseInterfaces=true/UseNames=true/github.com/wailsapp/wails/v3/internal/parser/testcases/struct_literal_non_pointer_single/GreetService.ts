...
export function MapIntInt($in: { [_: `${number}`]: number }): Promise<void> {
...
export function MapIntSliceInt($in: { [_: `${number}`]: number[] }): Promise<void> {
    let $resultPromise = $Call.ByName("main.GreetService.MapIntSliceInt", $in);
    return $resultPromise as any;
}

export function MapIntSliceIntInMapIntSliceIntOut($in: { [_: `${number}`]: number[] }): Promise<{ [_: `${number}`]: number[] }> {
...
export function PointerMapIntInt($in: { [_: `${number}`]: number } | null): Promise<void> {
