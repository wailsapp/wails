...
var _WailsSocket = class _WailsSocket extends EventTarget {
  ...
  _opened() {
    ...
    (_a3 = this.onopen) == null ? void 0 : _a3.call(this, ev);
  ...
  _message(payload) {
    ...
    (_a3 = this.onmessage) == null ? void 0 : _a3.call(this, ev);
    this.dispatchEvent(ev);
  }
  /** @internal */
  _fail(err) {
    ...
    (_a3 = this.onerror) == null ? void 0 : _a3.call(this, ev);
    this.dispatchEvent(ev);
  ...
  _closed(code, reason, wasClean) {
    ...
    (_a3 = this.onclose) == null ? void 0 : _a3.call(this, ev);
    this.dispatchEvent(ev);
  }
};
...
function deliver(buf) {
  ...
  if (buf.byteLength < 9 || dv.getUint8(0) !== 87 || dv.getUint8(1) !== 83 || dv.getUint8(2) !== 49 || dv.getUint8(3) !== 0) {
