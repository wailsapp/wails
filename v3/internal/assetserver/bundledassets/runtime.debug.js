...
async function runtimeCallWithID(objectID, method, windowName, args) {
  ...
  if (((_b = (_a4 = response.headers.get("Content-Type")) == null ? void 0 : _a4.indexOf("application/json")) != null ? _b : -1) !== -1) {
...
if (androidBridge) {
  ...
  window._wailsAndroidCallback = (id, response, error) => {
    ...
    try {
      ...
      if (!envelope.ok) {
        promise.reject(new Error((_a4 = envelope.error) != null ? _a4 : "unknown runtime call error"));
        return;
      }
...
function OpenFile(options) {
  var _a4;
  return (_a4 = dialog(DialogOpenFile, options)) != null ? _a4 : [];
}
...
function eventTarget(event) {
  ...
  if (event.target instanceof HTMLElement) {
    ...
    return (_a4 = event.target.parentElement) != null ? _a4 : document.body;
  } else {
...
function canResolveFilePaths() {
  var _a4, _b, _c, _d;
  if (((_b = (_a4 = window.chrome) == null ? void 0 : _a4.webview) == null ? void 0 : _b.postMessageWithAdditionalObjects) == null) {
    return false;
  }
...
function resolveFilePaths(x, y, files) {
  var _a4, _b;
  if ((_b = (_a4 = window.chrome) == null ? void 0 : _a4.webview) == null ? void 0 : _b.postMessageWithAdditionalObjects) {
...
function handleDragEnter() {
  var _a4, _b;
  if (((_b = (_a4 = window._wails) == null ? void 0 : _a4.flags) == null ? void 0 : _b.enableFileDrop) === false) {
    return;
  }
...
function setupDropTargetListeners() {
  ...
  docElement.addEventListener("dragenter", (event) => {
    var _a4, _b, _c;
    if (!((_a4 = event.dataTransfer) == null ? void 0 : _a4.types.includes("Files"))) {
      return;
    }
...
var _invoke = (function() {
  ...
  try {
    if ((_b = (_a4 = window.chrome) == null ? void 0 : _a4.webview) == null ? void 0 : _b.postMessage) {
...
function IsWindows() {
  var _a4, _b;
  return ((_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.OS) === "windows";
}
function IsLinux() {
  var _a4, _b;
  return ((_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.OS) === "linux";
}
function IsMac() {
  var _a4, _b;
  return ((_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.OS) === "darwin";
}
function IsIOS() {
  var _a4, _b;
  return ((_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.OS) === "ios";
}
function IsAndroid() {
  var _a4, _b;
  return ((_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.OS) === "android";
}
function IsMobile() {
...
function IsAMD64() {
  var _a4, _b;
  return ((_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.Arch) === "amd64";
}
function IsARM() {
  var _a4, _b;
  return ((_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.Arch) === "arm";
}
function IsARM64() {
  var _a4, _b;
  return ((_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.Arch) === "arm64";
}
function IsDebug() {
  var _a4, _b;
  return Boolean((_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.Debug);
}
...
function isMobile() {
  var _a4, _b;
  const os = (_b = (_a4 = window._wails) == null ? void 0 : _a4.environment) == null ? void 0 : _b.OS;
...
function startNonClientRegionTracking() {
  ...
  (_a4 = window.visualViewport) == null ? void 0 : _a4.addEventListener("resize", scheduleUpdate);
  (_b = window.visualViewport) == null ? void 0 : _b.addEventListener("scroll", scheduleUpdate);
}
function tryStartNonClientRegionTracking() {
  var _a4, _b;
  const os = (_a4 = window._wails.environment) == null ? void 0 : _a4.OS;
  if (os === void 0) {
    return false;
  }
...
var CancellablePromise = class _CancellablePromise extends Promise {
    ...
    return new _CancellablePromise((resolve, reject) => {
      void super.then(
        (value) => {
          ...
          (_a4 = barrier.resolve) == null ? void 0 : _a4.call(barrier);
          try {
  ...
  static withResolvers() {
    ...
    result.promise = new _CancellablePromise((resolve, reject) => {
      ...
      var _a4;
      (_a4 = result.oncancelled) == null ? void 0 : _a4.call(result, cause);
    });
    return result;
  }
};
...
function currentBarrier(promise) {
  var _a4;
  let pwr = (_a4 = promise[barrierSym]) != null ? _a4 : {};
  if (!("promise" in pwr)) {
...
var _a3;
var sessionID = hasDOM ? (window._wails = window._wails || {}, (_a3 = window._wails).__streamSession || (_a3.__streamSession = nanoid())) : nanoid();
...
function Stream(name) {
  var _a4;
  if (hasDOM) {
    const factory = (_a4 = window._wails) == null ? void 0 : _a4.streamFactory;
...
async function postBatch(connID, frames) {
  ...
  for (; ; ) {
    ...
    const accepted = Number((_a4 = resp.headers.get(HDR_BATCH)) != null ? _a4 : 0);
    sent += accepted;
