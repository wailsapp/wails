...
var _Window = class _Window {
  ...
  HandlePlatformFileDrop(filenames, x, y) {
    ...
    console.log("Window.HandlePlatformFileDrop: Dropped files at (".concat(x, ", ").concat(y, ") on element"), element);
