...
function isDraggableEvent(event) {
  ...
  return style.getPropertyValue("--wails-draggable").trim() === "drag" && event.offsetX - parseFloat(style.paddingLeft) < target.clientWidth && event.offsetY - parseFloat(style.paddingTop) < target.clientHeight;
}
var MouseDown = 0;
var MouseUp = 1;
var MouseMove = 2;
