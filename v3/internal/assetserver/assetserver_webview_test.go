...
func (r *contextWebViewResponse) Write(p []byte) (int, error) { return r.body.Write(p) }
func (r *contextWebViewResponse) WriteHeader(code int)        { r.code = code }
func (*contextWebViewResponse) Finish() error                 { return nil }
