...
This is a Wails-specific **internal** subsystem for the experimental YAML CLI
(issue #6021), not a public library or a general process supervisor.

`WAILS_EXP_USE_WAKE` must be present and the project must have `wails.yaml`.
...
marker prevents duplicate CLI diagnostics. YAML builds do not install a global
...
[argument reference](../../../docs/src/content/docs/reference/wails-yaml-run.md#development-application-arguments).
