...
enum {
    ...
    WailsSplitPaneRoleContentList = 3,
};
...
// Pane accessory hook (webview_window_accessory_darwin.m). Returns the
// installed NSSplitViewItem for a pane, or NULL before installation or after
// teardown. The item is borrowed. Must run on the application thread.
