...
var namedKeys = map[string]struct{}{
	...
	"space":     {},
	"delete":    {},
	// macOS reports the key above Delete on a full keyboard as this, and has
	// done since key bindings landed; without a name for it the accelerator
	// could not be parsed and every press was reported as an error.
	"forward delete": {},
	"home":           {},
	"end":            {},
	"page up":        {},
