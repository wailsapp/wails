...
// WebKit does not support resolving Blob-backed request bodies for custom URI
// schemes. On WebKitGTK, asking for that body crashes in
...
// bodies to ordinary bytes before WebKit hands a wails:// request to the native
// scheme handler.
//
