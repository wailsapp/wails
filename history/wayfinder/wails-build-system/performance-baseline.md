...
Measured 2026-08-16 on Linux/amd64 at `4db35ce43270` plus the uncommitted
manifest build-system implementation.
...
The checked-in baseline median is 83.332ms. The rebuilt current CLI measured
87.565ms and passed both the absolute 100ms budget and the 20% median-regression
budget. Raw checked-in samples remain in
