...
- The checked local audit measured a 99.092ms badge median with 5.05% MAD and
  ...
  103.367ms; every sample still had zero executed and six cached Nodes. This
  local run remains 3.367ms above the absolute controlled-run gate and must be
  repeated there. Dirty published binaries are regenerated byte-identically;
...
- The 2026-08-23 handoff audit removed hidden npm dependencies from ten
  ...
  bytes; it remains a failed absolute gate pending the controlled-run rerun.
