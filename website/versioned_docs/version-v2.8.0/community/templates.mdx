...
- [wails-next-tailwind-shadcnui-ts](https://github.com/vxxvvxxv/wails-next-tailwind-shadcnui-ts) - A template using Next.js (with app router + dark theme), TypeScript, TailwindCSS, and shadcn/ui
