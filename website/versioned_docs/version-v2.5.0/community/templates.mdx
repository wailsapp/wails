...
- [wails-sveltekit-ts](https://github.com/haukened/wails-sveltekit-ts) - A template using SvelteKit + Typescript
...
- [wails-qwil-template](https://github.com/LazyClicks/wails-qwik-template) - A template using Qwik
