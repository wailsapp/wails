...
## Solid
- [wails-vite-solid-js-template](https://github.com/xijaja/wails-template-solid-js) - A template using Solid + js + Vite
- [wails-vite-solid-ts-template](https://github.com/xijaja/wails-template-solid-ts) - A template using Solid + ts + Vite
