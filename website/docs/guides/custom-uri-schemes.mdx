# Custom URL Schemes association
...
## Set Up Custom URL Schemes Association:
...
|:------------|:--------------------------------------------------------------------------------------|
| scheme      | Custom URL scheme. e.g. myapp                                                         |
...
### macOS
When you open file (or files) with your app, the system will launch your app and call the `OnUrlOpen` functions in your Wails app. Example:
```go title="main.go"
func main() {
...
### Windows
On Windows Custom URL Schemes is supported only with NSIS installer. During installation, the installer will create a
...
1. Create a .desktop file for your app and specify file associations there (note that `%u` us important in Exec). Example:
```ini
[Desktop Entry]
Categories=Office
...
```
7. Now when your package is installed, your app will be associated with custom URL scheme. When you open url with your app,
