...
For another excellent guide on macOS code signing and notarization, see [Signing and Notarizing macOS Apps](https://armaan.cc/blog/signing-and-notarizing-macos) by Armaan.
