...
### macOS
When you open file (or files) with your app, the system will launch your app and call the `openFile` `openFiles` functions in your Wails app. Example:
```go title="main.go"
func main() {
	...
	err := wails.Run(&options.App{
		...
		OnFileOpen:       func(filePath string) { println(filestring) },
		OnFilesOpen:      func(filePaths []string) { println(filestring) },
		Bind: []interface{}{
			app,
		},
	})
