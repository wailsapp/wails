...
- Unexpected errors will cause the application to become unusable.  Only recovery option from unexpected errors is to reload the app.  To do this create a file myapp/frontend/src/hooks.client.ts then add the below to the file.
```
