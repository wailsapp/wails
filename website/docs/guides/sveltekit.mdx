...
- The simplest way is to call a function from the form is to, bind:value your variables and prevent submission `<form method="POST" on:submit|preventDefault={handle}>`
