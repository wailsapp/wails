...
- [wails-solid-js](https://github.com/theluqmn/wails-solid-js) - An updated wails template with Solidjs, Vite and JavaScript.
- [wails-solid-js-tailwind](https://github.com/theluqmn/wails-solid-js-tailwind) - A Wails template to develop Solidjs projects with JavaScript and Tailwind CSS.
