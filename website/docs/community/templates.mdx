...
- [wails-template-primevue-sakai](https://github.com/TekWizely/wails-template-primevue-sakai) - Wails starter using [PrimeVue's Sakai Application Template](https://sakai.primevue.org) (Vite, Vue3, PrimeVue4, TailwindCSS, Routing, Themes, Dark Mode, UI Components, more)
