...
- [wails-template-react-ts-tailwind-routerframework](https://github.com/RProduction/wails-template-react-ts-tailwind-routerframework) - A template for React with Typescript, TailwindCss, React Router Framework mode.
