...
<p style={{ "text-align": "center" }}>
  <img src={require("@site/static/img/showcase/redisviewer-overview1.webp").default} />
  <img src={require("@site/static/img/showcase/redisviewer-overview2.webp").default} />
  <br />
</p>
```
