...
By default, the desktop app will open during `wails dev`. Setting this to `true` means the desktop will not open during `wails dev`. Please use http://localhost:34115
