...
| EnableAutoplayWithoutUserAction | A Boolean value that indicates whether media can autoplay without a user gesture. [Apple Docs](https://developer.apple.com/documentation/webkit/wkwebviewconfiguration/1614793-mediatypesrequiringuseractionfor?language=objc)       |
