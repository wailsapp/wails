...
Actions show up as buttons in notifications. eg. "protocol"
...
Actions to be shown as buttons on the notification. Some notification servers may ignore actions.
