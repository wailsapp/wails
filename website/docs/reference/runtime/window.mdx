...
Go Signature: `WindowSetAlwaysOnTop(ctx context.Context)`

JS Signature: `WindowSetAlwaysOnTop()`

Sets the window AlwaysOnTop.

### WindowSetUnalwaysOnTop
Go Signature: `WindowSetUnalwaysOnTop(ctx context.Context)`

JS Signature: `WindowSetUnalwaysOnTop()`

Sets the window not AlwaysOnTop.
