...
| -devtools            | Allows the use of the devtools in the application window in production (when -debug is not used). F12 may be used to open the devtools window. *NOTE*: This option will make your application FAIL Mac appstore guidelines. Use for debugging only. |                                                                                                                                               |
