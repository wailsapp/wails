...
- Fixed `runtime:ready` being dispatched as an application message in the dev server, causing spurious "Unknown message from front end" errors for browser clients [#NNNN](https://github.com/wailsapp/wails/pull/NNNN) by @Trainingdlu
