...
- Added configurable Vite server timeout via `--viteservertimeout` flag and `viteServerTimeout` in wails.json [#4374](https://github.com/wailsapp/wails/pull/4374) by [@leaanthony](https://github.com/leaanthony)
