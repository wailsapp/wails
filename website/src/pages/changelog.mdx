...
### Added
- Added system tray runtime wrapper and platform implementations by [@SomeoneIsWorking](https://github.com/SomeoneIsWorking) in [#4991](https://github.com/wailsapp/wails/pull/4991)
