...
- Fixed `wails doctor` reporting `libwebkit` as missing on Arch Linux, which has replaced the unversioned `webkit2gtk` package with `webkit2gtk-4.1`. Doctor now also notes when the detected WebKit package needs `-tags webkit2_41` [#5775](https://github.com/wailsapp/wails/issues/5775) by @4RH1T3CT0R7
