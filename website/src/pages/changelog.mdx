...
- Fixed `runtime:ready` being dispatched as an application message in the dev server, causing spurious "Unknown message from front end" errors for browser clients [#5795](https://github.com/wailsapp/wails/issues/5795) by @Trainingdlu
