...
### Added
- Added `SetScreen` api for macOS, Windows, Linux in [PR](https://github.com/wailsapp/wails/pull/5067) by @atterpac

### Fixed
- Fixed `app.Screen` population on startup in Linux and macOS in [PR](https://github.com/wailsapp/wails/pull/5067) by @atterpac
