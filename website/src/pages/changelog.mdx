...
- Added new community template wails-htmx-tailwind-daisyui-template. Added by [@ltcovalt](https://github.com/ltcovalt) in [PR](https://github.com/wailsapp/wails/pull/4394)
