...
information on the new property can be found in updated
[schema](static/schemas/config.v2.json). Properties `prefix` and `suffix`
allow to controll generated JS entities in the `model.ts` file. Added by
@OlegGulevskyy in [PR](https://github.com/wailsapp/wails/pull/2101)
