...
- Fixed `wails dev` will fail if GOOS do not match the current system in [PR](https://github.com/wailsapp/wails/pull/3592) by [@xiaotushaoxia](https://github.com/xiaotushaoxia)
