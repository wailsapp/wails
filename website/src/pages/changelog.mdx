...
- Fixed devserver on Linux when using Vite >= `v3.0.0`. Fixed by @stffabi in [PR](https://github.com/wailsapp/wails/pull/2664)
- Fixed devserver on Windows when using Vite >= `v3.0.0` that might have triggered the WebView2 into a hang. Fixed by @stffabi in [PR](https://github.com/wailsapp/wails/pull/2664)
