...
### Changements
- Mise à jour de la recommandation pour le routeur Svelte en [#4085](https://github.com/wailsapp/wails/pull/4085) par [@benmccann](https://github.com/benmccann)

### Ajouts
- Ajout de la section « Branding» dans `wails doctor` pour identifier correctement Windows 11 [#3891](https://github.com/wailsapp/wails/pull/3891) par [@ronen25](https://github.com/ronen25)


## v2.10.1 - 2025-02-24

### Corrections
- Correction du problème [listenerOff](https://github.com/wailsapp/wails/issues/3850) par @leaanthony.
- Correction de problèmes de construction avec `darwin/universal` par @leaanthony.

## v2.10 - 2025-02-15

### Ajouts
- Ajout d'une option pour définir le nom de la classe de fenêtre sous Windows. Ajouté dans la [PR](https://github.com/wailsapp/wails/pull/3828) par @APshenkin

### Corrections
- Correction du bug de logging en mode dev par @attperac dans [#3972](https://wailsapp/wails/pull/3972)
- Correction des options de configuration `reloaddirs` dans wails.json par @atterpac dans [#4005](https//github.com/wailsapp/wails/pull/4005)
- La compilation croisée a échoué avec CGO corrigée dans la [PR](https://github.com/wailsapp/wails/pull/3795) par [@fcying](https://github.com/fcying)
- Utilisation de go-webview2 v0.1.17 pour corriger le problème natif de webview2loader, par @leaanthony
- Correction de l'exemple du menu macOS par @takuyahara dans cette [PR](https://github.com/wailsapp/wails/pull/3847)
- Correction de typos par @takuyahara dans cette [PR](https://github.com/wailsapp/wails/pull/3846)
- Correction d'une définition TS incorrecte de `WindowSetSize` par @leaanthony
- Modification pour s'assurer que showHiddenFiles fonctionne avec la boîte de dialogue de répertoire par @leaanthony dans cette [PR](https://github.com/wailsapp/wails/pull/3904)
- Corriger quelques commentaires dans cette [PR](https://github.com/wailsapp/wails/pull/3932) par @lvyaoting
- [windows] Correction d'un clignotage de fenêtre sans cadre lors de la minimisation/restauration en empêchant les redessinations inutiles [#3951](https://github.com/wailsapp/wails/issues/3951)
- Correction de l'échec de la construction de models.ts à cause des types Go non-json-encodable -[PR](https://github.com/wailsapp/wails/pull/3975) par [@pbnjay](https://github.com/pbnjay)
- Correction d'autres bugs d'exportation de liaisons et de typescript - [PR](https://github.com/wailsapp/wails/pull/3978) par [@pbnjay](https://github.com/pbnjay)
- Correction du processus de plantage de Dispatcher.ProcessMessage au lieu de renvoyer l'erreur - [PR](https://github.com/wailsapp/wails/pull/4016) [#4015](https://github.com/wailsapp/wails/issues/4015) par [@ronaldinho_x86](https://github.com/RonaldinhoL)
- Correction du plantage de Windows SaveDialog par [@leaanthony](https://github.com/leaanthony)
- Correction d'erreurs `buildvcs` par [@leaanthony](https://github.com/leaanthony)
- Correction des mises à jour des menus sur MacOS par [@stffabi](https://github.com/stffabi)
- Correction d'une erreur de compilation sur macOS qui se produisait lorsque les champs `outputfilename` et `name` dans wails.json étaient différents. Correction dans cette [PR](https://github.com/wailsapp/wails/pull/3789) par [@nickisworking](https://github.com/nickisworking)

### Changements
- Suppression des références de documentation pour 'Le nom du module par défaut dans go.mod est "changeme". Vous devriez changer cela en quelque chose de plus approprié." car il ne semble plus pertinent.
- Mise à jour du script dans le guide Mac App Store pour prendre en charge les noms des applications contenant des espaces, par@cristianrgreco
- Permettre de spécifier macos-min-version en externe. Implémenté par @APshenkin dans cette [PR](https://github.com/wailsapp/wails/pull/3756)
- Mise à jour de la documentation d'installation pour la dernière version de Linux os et le problème de libwebkit - [PR](https://github.com/wailsapp/wails/pull/3806) par [@pratikmota](https://github.com/pratikmota)
...
### Ajouts
- Prendre en charge go 1.24 par [@leaanthony](https://github.com/leaanthony)

### Corrections
- Changement pour utiliser la balise `-buildvcs=false` par défaut pour supprimer l'`erreur obtenant le statut VCS : état de sortie 128` - par [@leaanthony](https://github.com/leaanthony)

## v2.9.2 - 2024-09-18

### Corrections
- Correction du problème de mémoire CGO sur Darwin par @leaanthony dans cette [PR](https://github.com/wailsapp/wails/pull/3590)
- Correction d'une erreur qui se produisait lorsqu'un nom d'auteur contient un string qui n'est pas approprié pour JSON. Correction par @taiseiotsuka dans cette [PR](https://github.com/wailsapp/wails/pull/3638)
- Correction de la compilation MacOS pour utiliser l'option `outputfilename` de wails.json. [#3200](https://github.com/wailsapp/wails/issues/3200)
- Correction des événements de dépôt de fichiers sur windows. Correction dans cette [PR](https://github.com/wailsapp/wails/pull/3595) par @FrancescoLuzzi
- La commande doctor ne trouve pas pkg-config sur Solus. [PR #3670](https://github.com/wailsapp/wails/pull/3670) par [@ianmjones](https://github.com/ianmjones)
- Correction de la liaison pour les champs de structure qui étaient exportés mais n'avaient pas de balises json. [PR #3678](https://github.com/wailsapp/wails/pull/3678)
- Correction d'événements de drop de fichier sous Windows dans la [PR](https://github.com/wailsapp/wails/pull/3595), par @FrancescoLuzzi
- Les options `ZoomFactor` et `IsZoomControlEnabled` ont été modifiées pour uniquement  être des options Windows. Modifié dans la PR[#3644](https://github.com/wailsapp/wails/pull/3644) par @levinit
- Ajout de la vérification nulle pour le Drag-n-Drop sous Windows. Correction dans la [PR](https://github.com/wailsapp/wails/pull/3597) ouverte par @leaanthony sur la base de la suggestion de @Alpa-1 dans [#3596](https://github.com/wailsapp/wails/issues/3596).
- Correction de fautes de frappe dans divers fichiers .mdx. [PR #3628](https://github.com/wailsapp/wails/pull/3628) par [@deining](https://github.com/deining)
- Correction de la race condition de `notifyListeners()` quand elle est arrêtée durant l'exécution du processus - [PR](https://github.com/wailsapp/wails/pull/3695) par [@mrf345](https://github.com/mrf345)
- Correction des boites de dialogues dans Windows avec Go 1.23 - [PR](https://github.com/wailsapp/wails/pull/3707) par [@leaanthony](https://github.com/leaanthony)
- D'autres corrections de syscall pour le support de Go 1.23 - [PR](https://github.com/wailsapp/wails/pull/3713) par [@leaanthony](https://github.com/leaanthony)
- Correction de l'icône de curseur lors d'un drag and drop - [PR](https://github.com/wailsapp/wails/pull/3703) par [@mrf345](https://github.com/mrf345)

### Changements
- Documentation modifiée pour refléter la syntaxe de mot de passe correcte pour le fichier `gon-sign.json` - [PR](https://github.com/wailsapp/wails/pull/3620) par [@ignasbernotas](github.com/ignasbernotas)
## v2.9.1 - 2024-06-18

### Corrections
- Correction des problèmes de compilation sur Linux pour certaines versions de la glibc. Correction dans cette [PR](https://github.com/wailsapp/wails/pull/3545) par @leaanthony.

## v2.9.0 - 2024-06-16

### Ajouts
- Ajout du support du Glisser-Déposer (fichiers et dossiers) sur Windows et Linux. Ajouté par [@lyimmi](https://github.com/lyimmi) dans cette [PR](https://github.com/wailsapp/wails/pull/3203). Basé sur le travail de [@ayatkyo](https://github.com/ayatkyo) pour Windows dans la [PR](https://github.com/wailsapp/wails/pull/2774).
- Ajout de la prise en charge du Glisser-Déposer (fichiers ou dossiers) pour macOS. Ajouté par [@APshenkin](https://github.com/APshenkin) dans cette [PR](https://github.com/wailsapp/wails/pull/3250).
- Support de la compilation avec `libwebkit2gtk-4.1` au lieu de `4.0` pour supporter la dernière version d'Ubuntu - par [atterpac](https://github.com/atterpac) dans [#3465](https://github.com/wailsapp/wails/pull/3465)
- Guide approfondi sur le routage avec un exemple Svelte par [@stanislav-zeman](https://github.com/stanislav-zeman) dans [#3481](https://github.com/wailsapp/wails/pull/3481)
- Ajout de tests unitaires pour le fix [#3476](https://github.com/wailsapp/wails/pull/3476) par [gjergj](https://github.com/Gjergj) en [#3485](https://github.com/wailsapp/wails/pull/3485)
- Traduction en allemand du Readme par [Zeiichenfolge](https://github.com/Zeiichenfolge) dans [#3483](https://github.com/wailsapp/wails/pull/3483)
- Ajout du support générant des liaisons pour les structures sans champs. Ajouté par [gjergj](https://github.com/Gjergj) dans cette [PR](https://github.com/wailsapp/wails/pull/3489)

### Changements
- Mise à jour de plusieurs liens cassés dans la page "Comment ça marche?" du site Web. Changé par [@oguz-yilmaz](https://github.com/oguz-yilmaz) dans la [PR #3469](https://github.com/wailsapp/wails/pull/3469)
- Version de Go mise à jour en CI 1.22 par [@leaanthony](https://github.com/leaanthony) dans [#3473](https://github.com/wailsapp/wails/pull/3473).

### Corrections
- Correction du Glisser-Déposer JS. Ajouté par [@jakubpeleska](https://github.com/jakubpeleska), fourni par [Beam Transfer](https://beamtransfer.io) dans cette [PR](https://github.com/wailsapp/wails/pull/3516).
- Correction de la génération de type optionnelle où un extra `?` serait placé dans le nom de la variable au lieu de se mettre après. `"field?"?` vs `"field"?`. Correction par [@atterpac](https://github.com/atterpac) dans [#3476](https://github.com/wailsapp/wails/pull/3476)
- Correction d'un problème où les valeurs `WindowGetPosition` et `WindowSetPosition` étaient incohérentes sur MacOS. Fixé par [@cenan](https://github.com/wailsapp/wails/pull/3479)
- Correction de l'erreur de typo de la commande scoop. Correction par [@fieu](https://github.com/fieu) dans [#3501](https://github.com/wailsapp/wails/pull/3501)
- Correction de la réinitialisation de l'instance mono macOS après un certain temps. Correction par [@APshenkin](https://github.com/APshenkin) dans cette [PR](https://github.com/wailsapp/wails/pull/3526)

## v2.8.2 - 2024-05-08

### Breaking Change
- Le drapeau `-noPackage` a été mal nommé et est en cours de renommage en `nopackage` pour correspondre à la nomenclature des autres drapeaux. Changé par @leaanthony dans cette [PR](https://github.com/wailsapp/wails/issues/3421).

### Ajouts
- Ajout de la prise en charge d'un proxy pour les requêtes récupérant des ressources auprès d'un serveur externe. Ajouté par @leaanthony dans cette [PR](https://github.com/wailsapp/wails/pull/3463)

### Corrections
- Correction d'un problème avec l'icône manquante pour Windows. Correction par [@APshenkin](https://github.com/wailsapp/wails/pull/3400)

## v2.8.1 - 2024-04-11

### Ajouts

- Ajout de docs aide à indiquer que dans les options de l'IDE vous pouvez choisir entre vscode et goland. Ajouté par @DiegPS dans cette [PR](https://github.com/wailsapp/wails/pull/3419)
- Ajout de docs pour aider à résoudre le problème css de taille de police dans NixOs/Wayland. Ajouté par @atterpac dans cette [PR](https://github.com/wailsapp/wails/pull/3268)
- Ajout du flag -m (sauter `go mod tidy`) à la commande de dev par @te5se dans cette [PR](https://github.com/wailsapp/wails/pull/3275)
- Ajout de l'option mac `DisableZoom` pour supprimer le bouton de zoom. Ajouté par @wizzymore dans cette [PR](https://github.com/wailsapp/wails/pull/3289)

### Corrections

- Correction d'un problème où les directives incorporées avec des chemins suivant des patterns créaient des répertoires illégaux. Changé par [@twonull](https://github.com/twonull) dans cette [PR](https://github.com/wailsapp/wails/pull/3445)
- Correction d'un problème où certains appels à createFrom dans TypeScript échouaient. Changé par [@twonull](https://github.com/twonull) dans cette [PR](https://github.com/wailsapp/wails/pull/3435)
- Correction de certaines fautes de frappe dans les commentaires. Changé par [@reallylowest](https://github.com/reallylowest) dans cette [PR](https://github.com/wailsapp/wails/pull/3357)
- Correction d'un problème où le fichier de destination n'était pas correctement fermé après la copie. Changé par [@testwill](https://github.com/testwill) dans cette [PR](https://github.com/wailsapp/wails/pull/3384)
- Correction d'un problème où les appels `xattr` ne fonctionnaient pas. Correction par [@leaanthony](https://github.com/wailsapp/wails/pull/3328)
- Ajout d'un avertissement dans la documentation que la version fixant le runtime WebView 2 doit être extrait du fichier téléchargé avant de l'utiliser. Documenté par [@ALizarazoTellez](https://github.com/ALizarazoTellez) dans cette [PR](https://github.com/wailsapp/wails/pull/3444).

### Changements

- Changement du nom par défaut par celui du projet. Changé par [@Twacqwq](https://github.com/Twacqwq) dans cette [PR](https://github.com/wailsapp/wails/pull/3303)

## v2.8.0 - 2024-02-08

### Ajouts

- Les options Windows ajoutées prennent en charge la configuration `DisablePinchZoom`. Ajouté par @tuuzed dans cette [PR](https://github.com/wailsapp/wails/pull/3115)
- Ajouter la détection du matériel Silicon d'Apple dans `wails doctor`. Changé par @almas1992 dans cette [PR](https://github.com/wailsapp/wails/pull/3129)
- Supprimer l'attribut de quarantaine sur les binaires macOS. Changé par @leaanthony dans cette [PR](https://github.com/wailsapp/wails/pull/3118)
- Ajout de la documentation pour une erreur GStreamer courante sur les systèmes Linux. Changé par [@mkwsnyder](https://github.com/mkwsnyder) dans cette [PR](https://github.com/wailsapp/wails/pull/3134)
- Ajout de la documentation sur un exemple explicite d'import de runtime JS. Changé par [@danawoodman](https://github.com/danawoodman) dans cette [PR](https://github.com/wailsapp/wails/pull/3178)
- Ajouter l'icône du dock à l'aide du bouton droit de la souris par @almas1992 dans cette [PR](https://github.com/wailsapp/wails/pull/3157)

### Corrections
- Erreur de construction du modèle vue-ts. Correction par @atterpac dans cette [PR](https://github.com/wailsapp/wails/pull/3243)
- Docs pour IsZoomControlEnabled et ZoomFactor. Correction par @leaanthony dans cette [PR](https://github.com/wailsapp/wails/pull/3137)
- Correction du drapeau `-compiler` pour `wails build`, `wails dev` et `wails generate module`. Correction dans cette [PR](https://github.com/wailsapp/wails/pull/3121) par [@xtrafrancyz](https://github.com/xtrafrancyz)
- Correction de la non initialisation de `SecondInstanceData.WorkingDirectory`  sur linux et windows ([#3154](https://github.com/wailsapp/wails/pull/3154)).
- Correction de la documentation de React Routing pour ajouter 'Routes' et 'Route'. Correction par @doracpphp dans cette [PR](https://github.com/wailsapp/wails/pull/3206)
- Correction de la boîte de dialogue de sauvegarde n'ajoutant pas automatiquement l'extension de fichier sous Windows par @almas1992 dans cette [PR](https://github.com/wailsapp/wails/pull/3205)
- Correction de la compatibilité pour wails cli construit avec go 1.22 et plus. Correction par @stffabi dans cette [PR](https://github.com/wailsapp/wails/pull/3244)
- Documentation corrigée pour les types de retour de l'API Window . Correction par @jangler dans cette [PR](https://github.com/wailsapp/wails/pull/3247)
...
### Changements
- Go 1.20 est maintenant la version minimale de Go supportée.
...
- Ajout de validation sur les paths des requêtes pour AssetServer. Ajouté par @stffabi dans cette [PR](https://github.com/wailsapp/wails/pull/2235)
- Ajout d'un nouveau guide pour l'App Store. Ajouté par @achhabra2 dans cette [PR](https://github.com/wailsapp/wails/pull/2142)
- Ajout d'une vérification supplémentaire sur libwebkit pour le gestionnaire de paquets dnf (requis pour la dernière version de Fedora). Correction par @NullCode1337 dans cette [PR](https://github.com/wailsapp/wails/pull/2218)
- Ajout du nouveau drapeau `-nomodsync` pour désactiver la synchronisation automatique du fichier `go.mod`. Ajouté par @leaanthony dans cette [PR](https://github.com/wailsapp/wails/pull/2215)
- Ajout du support pour l'ajout de préfixes et de suffixes aux classes Typescript générées. Ajouté par @OlegGulevskyy dans [PR](https://github.com/wailsapp/wails/pull/2101)
- Ajout de la référence à NSIS comme dépendance optionnelle. Ajouté par @acheong08 dans cette [PR](https://github.com/wailsapp/wails/pull/2070)
- Ajout de la traduction coréenne pour le site web. Ajouté par @cybertramp dans cette [PR](https://github.com/wailsapp/wails/pull/2093)
...
- L'exécution locale des docs a été cassée en raison de la prérequis de jeton crowdin obligatoire. Correction par @OlegGulevskyy dans cette [PR](https://github.com/wailsapp/wails/pull/2231)
- Le typescript généré pour les fonctions Go qui retournaient une seule erreur était incorrecte. Correction par @ATenderholt dans cette [PR](https://github.com/wailsapp/wails/pull/2247)
- L'événement de la souris droite n'était pas capturé correctement pour Linux. Correction par @leaanthony dans cette [PR](https://github.com/wailsapp/wails/pull/2190)
- Supprimer les espaces supplémentaires dans la version de Wails lors de la requête sur `go.mod`. Correction par @matholt dans cette [PR](https://github.com/wailsapp/wails/pull/2197)
- Correction des tests en erreur sur Mac Correction par @avengerweb dans cette [PR](https://github.com/wailsapp/wails/pull/2187)
- Corriger les erreurs de test. Correction par @misitebao & @avengerweb dans [ces](https://github.com/wailsapp/wails/pull/2169) [PRs](https://github.com/wailsapp/wails/pull/2187)
- Ajout de `WindowSetAlwaysOnTop` dans le runtime JS. Fixé par @gotid dans la [PR](https://github.com/wailsapp/wails/pull/2128)
- Correction de la typo sur le drapeau d'obfusquage dans la documentation. Correction par @ckilb dans la [PR](https://github.com/wailsapp/wails/pull/2102)
- Correction du lien vers le Hash Router React dans la documentation. Correction par @marvinhosea dans la [PR](https://github.com/wailsapp/wails/pull/2050)
