...
- `build/bin` folder was duplicating itself on each reload in `wails dev` mode. Corrigé par @OlegGulevskyy dans cette [PR](https://github.com/wailsapp/wails/pull/2103)
