...
- MacOS 10.15+ AMD64 pour le développement, MacOS 10.13+ pour la publication
- MacOS 11.0+ ARM64
- Linux AMD64/ARM64
...
- Go 1.21+ (macOS 15+ requiert Go 1.23.3+)
- NPM (Node 15+)
...
>
  ...
  <TabItem value={"Linux"}>
    ...
    Si vous utilisez la dernière version de Linux (exemple : Ubuntu 24. 4) et qu'il ne supporte pas <code>libwebkit2gtk-4. -dev</code>, alors vous pourriez rencontrer un problème dans le <code>wails doctor</code>: <code>libwebkit</code> introuvable. Pour résoudre ce problème, vous pouvez installer <code>libwebkit2gtk-4.1-dev</code> et pendant votre compilation, utilisez le tag <code>-tags webkit2_41</code>.
  </TabItem>
</Tabs>
```
