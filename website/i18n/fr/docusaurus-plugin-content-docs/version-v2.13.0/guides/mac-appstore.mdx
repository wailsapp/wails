...
**Ajouter le profil de provisionnement incorporé** Le profile de provisionnement créé ci-dessus doit être ajouté à la racine de l'application. Il doit être nommé embedded.provisionprofile.
