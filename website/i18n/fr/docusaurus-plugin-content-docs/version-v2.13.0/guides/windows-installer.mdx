...
Vous pouvez installer avec [Scoop](https://scoop.sh/) (qui l'ajoutera automatiquement à votre PATH):
...
Ou, vous pouvez utiliser Winget (pour Windows 10+):
