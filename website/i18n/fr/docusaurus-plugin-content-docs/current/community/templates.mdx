...
- [wails-template-tdesign-js](https://github.com/tongque0/wails-template-tdesign-js) - Modèle Wails basé sur TDesign UI (une librairie Vue 3 UI de Tencent), utilisant Vite, Pinia, Vue Router, ESLint, et Prettier.
...
- [wails-template-nextjs-app-router](https://github.com/thisisvk-in/wails-template-nextjs-app-router) - Un modèle utilisant Next.js et TypeScript avec un routeur
...
- [wails-nextjs-tailwind-template](https://github.com/kairo913/wails-nextjs-tailwind-template) - Un modèle utilisant Next.js et Typescript avec TailwindCSS
...
- [wails-vite-svelte-ts-tailwind-template](https://github.com/xvertile/wails-vite-svelte-tailwind-template) - Un modèle utilisant Wails, Svelte, Vite, TypeScript et TailwindCSS v3
...
- [wails-lit-shoelace-esbuild-template](https://github.com/Braincompiler/wails-lit-shoelace-esbuild-template) - Modèle Wails fournissant une interface avec lit, une bibliothèque de composants Shoelace, ainsi que prettier et typescript préconfigurés.
