...
Le fichier téléchargé sera compressé (extension `.cab`), donc vous devez l'extraire avant de l'utiliser. En suivant les instructions sur le [site officiel](https://learn.microsoft.com/en-us/microsoft-edge/webview2/concepts/distribution#details-about-the-fixed-version-runtime-distribution-mode), la commande pour extraire le fichier est :

```
expand {chemin vers le package} -F:* {chemin vers le dossier de destination}
```
