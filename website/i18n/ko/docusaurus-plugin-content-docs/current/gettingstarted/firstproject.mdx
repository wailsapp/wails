...
<TabItem value="Svelte">
    자바스크립트를 사용하여 <a href={"https://svelte.dev/"}>Svelte</a> 프로젝트를 생성합니다. with:<br/><br/>

    wails init -n myproject -t svelte

만약 타입스크립트를 사용하기를 원한다면:<br/>

    wails init -n myproject -t svelte-ts

</TabItem>
<TabItem value="React">
    자바스크립트를 사용하여 <a href={"https://reactjs.org/"}>React</a> 프로젝트를 생성합니다. with:<br/><br/>
...
<TabItem value="Vue">
    자바스크립트를 사용하여 <a href={"https://vuejs.org/"}>Vue</a> 프로젝트를 생성합니다. with:<br/><br/>
...
<TabItem value="Preact">
    자바스크립트를 사용하여 <a href={"https://preactjs.com/"}>Preact</a> 프로젝트를 생성합니다. with:<br/><br/>
...
<TabItem value="Lit">
    자바스크립트를 사용하여 <a href={"https://lit.dev/"}>Lit</a> 프로젝트를 생성합니다. with:<br/><br/>
...
<TabItem value="Vanilla">
    자바스크립트를 사용하여 Vanilla 프로젝트를 생성합니다. with:<br/><br/>
