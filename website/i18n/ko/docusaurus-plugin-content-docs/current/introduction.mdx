...
[varly](https://varly.app)는 Wails를 사용하여 작성된 MacOS & Windows용 데스크톱 애플리케이션입니다. Not only does it look great, it uses native menus and translucency - everything you'd expect from a modern native app.
