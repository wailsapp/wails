...
<TabItem value="Svelte">
    Сгенерируйте проект <a href={"https://svelte.dev/"}>Svelte</a> использующий JavaScript запустив:<br/><br/>

    wails init -n myproject -t svelte
Если вы предпочитаете TypeScript:<br/>

    wails init -n myproject -t svelte-ts

</TabItem>
<TabItem value="React">
    Сгенерируйте проект <a href={"https://reactjs.org/"}>React</a> использующий JavaScript запустив:<br/><br/>
...
<TabItem value="Vue">
    Сгенерируйте проект <a href={"https://vuejs.org/"}>Vue</a> использующий JavaScript через:<br/><br/>
...
<TabItem value="Preact">
    Сгенерируйте проект <a href={"https://preactjs.com/"}>Preact</a> использующий JavaScript запустив:<br/><br/>
...
<TabItem value="Lit">
    Сгенерируйте проект <a href={"https://lit.dev/"}>Lit</a> использующий JavaScript запустив:<br/><br/>
...
<TabItem value="Vanilla">
    Сгенерируйте проект Vanilla использующий JavaScript запустив:<br/><br/>
