...
- [Lea Anthony](https://github.com/leaanthony) - Владелец проекта, ведущий программист
- [Stffabi](https://github.com/stffabi) - Технический руководитель, разработчик и сопровождающий
- [Misitebao](https://github.com/misitebao) - Мастер документации, Китайский перевод, тестирование на Windows, Общий поиск ошибок
- [Travis McLane](https://github.com/tmclane) - работа кросс-помпиляции, тестирование на MacOS
- [Byron Chris](https://github.com/bh90210) - Мастер дистрибутивов Linux, тестирование на Linux
...
- [John Chadwick](https://github.com/jchv) - Его потрясающая работа над [go-webview2](https://github.com/jchv/go-webview2) и [go-winloader](https://github.com/jchv/go-winloader) сделала версию для Windows возможной.
- [Tad Vizbaras](https://github.com/tadvi) - Его проект "winc" был первым шагом к Wails на чистом Go.
- [Mat Ryer](https://github.com/matryer) - За советы, поддержку и общение.
- [Dustin Krysak](https://wiki.ubuntu.com/bashfulrobot) - Его поддержка и отзывы были бесценны.
- [Justen Walker](https://github.com/justenwalker/) - For helping wrangle COM issues which got v2 over the line.
- [Wang, Chi](https://github.com/patr0nus/) - Проект DeskGap оказал огромное влияние на направление Wails v2.
- [Serge Zaitsev](https://github.com/zserge) - Хотя Wails не использует проект Webview, он до сих пор является источником вдохновения.
