...
O runtime do Wails fornece um mecanismo de registro que pode ser chamado de Go ou Javascript. Como a maioria dos registros de, há um número de níveis de log:
...
Define o nível de log. Em Javascript, o número diz respeito aos seguintes níveis de log:
