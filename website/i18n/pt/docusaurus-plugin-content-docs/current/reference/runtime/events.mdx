...
O tempo de execução do Wails fornece um sistema unificado de eventos onde os eventos podem ser emitidos ou recebidos por Go ou Javascript. Opcionalmente, dados podem ser passados com os eventos. Os ouvintes receberão os dados nos tipos de dados locais.
