...
Nếu bạn cài đặt NSIS một cách thủ công, thì bạn phải thêm thư mục _Bin_, thư mục này chứa tệp tin `makensis.exe`, trong gói cài đặt NSIS vào đường dẫn thư mục gốc của bạn. [Đây](https://www.architectryan.com/2018/03/17/add-to-the-path-on-windows-10/) là một ví dụ cụ thể về cách thức thêm đường dẫn trên Windows.
