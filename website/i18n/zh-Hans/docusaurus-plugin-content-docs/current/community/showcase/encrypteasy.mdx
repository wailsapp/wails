...
**[EncryptEasy](https://www.encrypteasy.app) is a simple and easy to use PGP encryption tool, managing all your and your contacts keys. Encryption should be simple. Developed with Wails. Encryption should be simple. Developed with Wails. Encryption should be simple. Developed with Wails.**
