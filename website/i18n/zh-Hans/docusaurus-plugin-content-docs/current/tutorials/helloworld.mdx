...
The aim of this tutorial is to get you up and running with the most basic application using Wails. You will be able to: 您将能够：
...
This will create a new directory called `helloworld` in the current directory. In this directory, you will find a number of files: 在这个目录中，您会找到一些文件：
