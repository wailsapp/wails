...
```json
{
    ...
    "frontend:dir": "[Relative path to the frontend directory. Defaults to 'frontend'. If not default, be sure to change your embed directive or target 'frontend/dist']",
