...
v2 中的运行时比 v1 丰富得多，支持菜单、窗口操作和更好的对话框。 The signature of the methods has changed slightly - please refer to the [Runtime Reference](../reference/runtime/intro.mdx).
