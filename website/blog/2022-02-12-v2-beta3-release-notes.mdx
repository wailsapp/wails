...
<div class="text--center">
    <img src="/img/wails-linux.png" width="60%" style={{"box-shadow": "rgb(255 255 255 / 20%) 0px 4px 8px 0px, rgb(104 104 104) 0px 6px 20px 0px"}}/>
</div>
<br/>
...
<div class="text--center">
    <img src="/img/wails-menus-linux.png" width="80%" style={{"box-shadow": "rgb(255 255 255 / 20%) 0px 4px 8px 0px, rgb(104 104 104) 0px 6px 20px 0px"}}/>
</div>
<br/>
...
And finally, I'd like to give a special thank you to all the [project sponsors](/docs/credits#sponsors) whose support
